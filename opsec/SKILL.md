...
metadata:
  ...
  related_skills: ["seal-iam", "seal-incident-management", "seal-user-team-security", "seal-privacy", "seal-awareness", "seal-threat-modeling", "seal-dprk-it-workers"]
---
...
## When to Use
- User asks about opsec practices, policies, or procedures
- Incident or scenario involving opsec concepts
- Need guidance on opsec frameworks or implementations
- Security training or awareness question touching this domain

## Related Domains
This skill connects to: seal-iam, seal-incident-management, seal-user-team-security, seal-privacy, seal-awareness, seal-threat-modeling, seal-dprk-it-workers
Use `skill_view("seal-iam")` if the question spans multiple areas.
...
- Web3 Considerations
- ... and 54 more detailed reference files
