...
metadata:
  ...
  related_skills: ["seal-community-management", "seal-awareness", "seal-opsec"]
---
...
## When to Use
- User asks about user team security practices, policies, or procedures
- Incident or scenario involving user team security concepts
- Need guidance on user team security frameworks or implementations
- Security training or awareness question touching this domain

## Related Domains
This skill connects to: seal-community-management, seal-awareness, seal-opsec
Use `skill_view("seal-community-management")` if the question spans multiple areas.
